...
var gbgs = {
    ...
    gnbEvent: function() {
        ...
        function pcEvent() {
            var header = $("#header"),
                gnb = $("#gnb"),
                gnbbtn = gnb.find("h2 a"),
                depth = gnb.find(".depth"),
                spd = 200,
                _temp = false;
    ...
    footerEvent: function() {
        ...
        $(".footer-select .sel-type1").on("change", function() {
            if (
                $("option:selected", this).val() == undefined ||
                $("option:selected", this).val() == null ||
    ...
    tabEvent: function(tabName, hasClassName, contName, liName) {
        ...
        $(tabName)
            ...
            .on("click", function() {
                ...
                curr = $(this).index();
                $(this)
                    .addClass(hasClassName)
                    .siblings()
                    .removeClass(hasClassName);
                $(contName)
                    .eq(curr)
                    .show()
                    .siblings(contName)
...
var plugin_tab = (function() {
    // TAB SHOW / HIDE
    var tabName = ".js-tab",
        hasClassName = "current",
        contName = ".tab-contents",
        liName = "li",
        curr = 0;
    ...
    $(tabName)
        .find("." + hasClassName)
        .append("<span class='hidden'>현재 선택 탭</span>");
